...
# Second, lets look  happiness by country
...
#add labels
  labs(x="Continent", y="Average Happiness Score",title = "Oceania is the happiest continent", subtitle = "Average Happiness Score by country")+
...
# add labels
  labs(title="The higher social support, the higher the happiness score",
       subtitle = "Relationship between happiness score and social support", x="Social Support",
       y="Happiness Score")+
...
# add labels
  labs(title="The higher the life expectancy, the higher the happiness score",
       subtitle = "Relationship between happiness score and life expectancy", x="Life Expectancy",
       y="Happiness Score")+
...
# Now let's go back to our orginal data set
